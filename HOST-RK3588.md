...
上面那轮测试自身把板子从 **43 °C / load 0.47** 推到 **63 °C / load 3.78**，而第二次 A 比
第一次差 88 ms、rtf 从 1.0362 升到 1.0417。**也就是说这个工作点会被自己产生的热和负载推着
往更坏走**，而连续对话正是这种负载。此前所有 TTS 基准都是单轮或短序列，没有测过这一点，
所以"连续 N 轮长回复后是否还守得住"目前是未知的——它比单次的 −372 ms 更接近真实使用。
