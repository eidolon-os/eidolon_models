...
| TTS CosyVoice2 | NPU (RKLLM + RKNN) | 首包 **1998 ms**，稳态 rtf **1.015** ✗ | §2.11 §2.12 §2.17 |
...
| CosyVoice2 | 绑 **A76 4–6** | 三核 rtf 0.926，四核 1.015 |
...
* **CosyVoice2 稳态 rtf 中位 1.015 > 1**，空载也只有 0.924（余量 8%），
  每轮 3 次 underrun。**这是模型在这块板上的能力边界，不是争用造成的。**
